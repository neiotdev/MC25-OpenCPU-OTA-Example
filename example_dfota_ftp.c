 ...
 * Description:
 * ------------
 *   This example demonstrates how to use dfota_ftp function with RIL APIs in OpenCPU.
 ...
 *   Compile & Run:
 *
 *     Set "C_PREDEF=-D __EXAMPLE_DFOTA_FTP__" in gcc_makefile file. And compile the 
...
* Define local param
****************************************************************************/
#define APP_START_FLAG_STRING "\r\n<--x-x-x-x-x-x-FTP_DFOTA_APP-x-x-x-x-x-x-->\r\n\r\n"
#define APN      "cmnet"
#define USERID   ""
#define PASSWD   ""

#define FTP_SVR_ADDR    "101.95.xxx.xxx"
#define FTP_SVR_PORT    "21"
#define FTP_SVR_PATH    "/quectel/"
#define FTP_USER_NAME   "test"
#define FTP_PASSWORD    "test"
#define FTP_FILENAME    "MC25_DFotahftp_app.pack"
